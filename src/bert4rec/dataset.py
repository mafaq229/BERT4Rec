...
class Bert4RecDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Create attention masks (1 for real items, 0 for masked/padded items)
        target_mask = [1 if item != MASK else 0 for item in target_items]
        source_mask = [1 if item != MASK else 0 for item in source_items]
